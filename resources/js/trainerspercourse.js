var deleteFunction = function (id) {
    let r = confirm('Do you really want to delete this Trainer for this Course?');
    if (r === true) {
        window.location.href = 'http://127.0.0.1:5500/deletepersonnel?id=' + id;
    }
}
...
$(document).ready(function () {
    ...
    $('#coursesShow').change(function () {
        ...
        var personnelJSONPath = "https://api.myjson.com/bins/idwvj";
        ...
        if ($('#coursesShow').val() == 0) {
            ...
            let html = '<button type="button" id="add-btn" class="btn btn-success" data-toggle="modal" data-target="#Modal" data-message="Add this Trainer" data-course="'+coID+'"><i class="far fa-plus-square"></i> Add a new Trainer to this Course</button>';
